...
class Shanxralipayh5Controller extends PayController
{
    protected $privateCertPath = '/www/wwwroot/juhe.cn/Data/cert/6888805043623.pfx';

    protected $publicCertPath = '/www/wwwroot/juhe.cn/Data/cert/sand.cer';
