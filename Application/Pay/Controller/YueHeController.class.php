...
class YueHeController extends PayController
{
    ...
    public function Pay($array)
    {
		...
		$data = [
			...
			'orderAmt' => sprintf('%.2f', $return['amount']),
		...
		// 页面上打印url地址出来下游可以自行包装
        echo json_encode(['code' => '0', 'msg' => '成功', 'url' => $result['data']['payurl']]);
		exit;
        // header('Location: '.$result['data']['payurl']);直接唤醒alipay
    }
    ...
    public function callbackurl()
    {
        ...
        if($pay_status <> 0){
            $this->EditMoney($data['merReqNo'], 'YueHe', 1);
    ...
    public function notifyurl()
    {
        ...
        file_put_contents('/Data/YueHe.txt', $log.PHP_EOL, FILE_APPEND);
        ...
        $this->EditMoney($data['orderId'], 'YueHe', 0);
